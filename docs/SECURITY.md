...
- Zod input validation, request-size limits, rate limiting, idempotency for job/export creation, and CSRF/origin protection for mutations
...
- Restrict database/Redis networks; enable TLS, backups, point-in-time recovery, and tested restore procedures.
...
- Review platform admins and Actor allowlists at least quarterly.
